                    ...
                    <div class="club-card__info">
                        ...
                        <svg class="club-card__icon">
                            <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                xlink:href="https://www.premierleague.com/resources/rebrand/v7.145.0/i/svg-output/icons.svg#icn-arrow-right">
                            </use>
                        </svg>
                    </div>
                    <div class="club-card__background">
                        <svg class="club-card__svg club-card__gradient-svg" viewBox="-80 -70 750 150" fill="none"
                            xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
                            <defs>
                                <linearGradient id="svg-gradient-var" x1="671.5" y1="-2543.5" x2="2774.42" y2="-903.522"
                            ...
                            <path
                                ...
                                fill="url(#svg-gradient-var)"></path>
                        </svg>
                        <svg class="club-card__svg club-card__club-svg" viewBox="-80 -70 750 150"
